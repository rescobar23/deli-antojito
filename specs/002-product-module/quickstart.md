...
3. Add a product with a unique name, valid base price, optional JPG/PNG image up to 2 MB and active status.
...
8. Edit the product and confirm the existing record updates without creating a duplicate.
9. Delete the product, cancel once, then confirm deletion; verify the product disappears and totals update.
10. Restart the app and confirm persisted products remain, while physically deleted products do not return.
